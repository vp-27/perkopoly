...
const AuthForm: React.FC = () => {
  ...
  // These would normally connect to your auth system
  ...
  return (
    <div className="max-w-md w-full mx-auto">
      <Card className="glass-card shadow-lg border-0 animate-scale-in">
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-center">
            Welcome to PerkPal
          </CardTitle>
          <CardDescription className="text-center">
            Manage all your rewards in one beautiful place
          </CardDescription>
        </CardHeader>
        <CardContent>
